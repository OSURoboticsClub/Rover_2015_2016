...
purple_out_low  = [120, 38, 127]
purple_out_high = [135, 166, 255]
purple_in_low   = [115, 70, 0]
purple_in_high  = [180, 255, 255] 
...
def filters():
    ...
    purple = 'purple'
    purple_lower = purple_out_low
    purple_upper = purple_out_high 
