...
#include <ros.h>
#include <ros/time.h>
#include <flodometry/motion_read.h>
...
ros::NodeHandle  nh;
flodometry::motion_read motion_read;
ros::Publisher pub_range("/optical_flow", &motion_read);
char frameid[] = "/optical_flow";
...
void loop() 
{
  ...
  motion_read.motion = (int)md.motion;
  motion_read.dx = (int)md.dx;
  motion_read.dy = (int)md.dy;
